...
//      $mac = shell_exec('arp '.$ip.' | awk \'{print $4}\'');
	...
	$sql1 = "SELECT * FROM orders ORDER BY username DESC";
										...
										<div class="table-responsive">
											<table class="table table-bordered mb-none">
												...
												<tbody>
													...
													$sql = "SELECT username, GROUP_CONCAT(food SEPARATOR ',') food, GROUP_CONCAT(quantity SEPARATOR ',') quantity FROM orders GROUP BY username ORDER BY id DESC";
